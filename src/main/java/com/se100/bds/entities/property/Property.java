package com.se100.bds.entities.property;
...
public class Property extends AbstractBaseEntity {
    ...
    @OneToMany(mappedBy = "property", cascade = CascadeType.ALL, orphanRemoval = true)
    @Builder.Default
    private List<com.se100.bds.entities.appointment.Appointment> appointments = new ArrayList<>();
    ...
    @OneToMany(mappedBy = "property", cascade = CascadeType.ALL, orphanRemoval = true)
    @Builder.Default
    private List<com.se100.bds.entities.document.IdentificationDocument> documents = new ArrayList<>();
}
